(()=>{var W=Object.defineProperty;var k=(t,e,i)=>e in t?W(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var r=(t,e,i)=>k(t,typeof e!="symbol"?e+"":e,i);var V=`#version 300 es
...
}`;function N(){let t=navigator.userAgent.toLowerCase();return t.includes("safari")&&!t.includes("chrome")&&!t.includes("android")}function X(t){var n,c;let e=(n=visualViewport==null?void 0:visualViewport.scale)!=null?n:1,i=(c=visualViewport==null?void 0:visualViewport.width)!=null?c:window.innerWidth,o=window.innerWidth-t.documentElement.clientWidth,a=e*i+o,s=outerWidth/a,l=Math.round(100*s);return l%5===0?l/100:l===33?1/3:l===67?2/3:l===133?4/3:s}var v={none:0,contain:1,cover:2};var z=`
...
`;var _={none:0,circle:1,daisy:2,diamond:3,metaballs:4};function f(t){if(Array.isArray(t))return t.length===4?t:t.length===3?[...t,1]:b;if(typeof t!="string")return b;let e,i,o,a=1;if(t.startsWith("#"))[e,i,o,a]=Y(t);else if(t.startsWith("rgb")){let s=j(t);if(s===null)return b;[e,i,o,a]=s}else if(t.startsWith("hsl")){let s=q(t);if(s===null)return b;[e,i,o,a]=Z(s)}else return console.error("Unsupported color format",t),b;return[R(e,0,1),R(i,0,1),R(o,0,1),R(a,0,1)]}function Y(t){if(t=t.replace(/^#/,""),(t.length===3||t.length===4)&&(t=t.split("").map(s=>s+s).join("")),t.length===6&&(t=t+"ff"),!/^[0-9a-f]{8}$/i.test(t))return console.warn("Invalid hex color"),b;let e=parseInt(t.slice(0,2),16)/255,i=parseInt(t.slice(2,4),16)/255,o=parseInt(t.slice(4,6),16)/255,a=parseInt(t.slice(6,8),16)/255;return[e,i,o,a]}function j(t){var i,o,a;let e=t.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i);return e?[parseInt((i=e[1])!=null?i:"0")/255,parseInt((o=e[2])!=null?o:"0")/255,parseInt((a=e[3])!=null?a:"0")/255,e[4]===void 0?1:parseFloat(e[4])]:null}function q(t){var i,o,a;let e=t.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i);return e?[parseInt((i=e[1])!=null?i:"0"),parseInt((o=e[2])!=null?o:"0"),parseInt((a=e[3])!=null?a:"0"),e[4]===void 0?1:parseFloat(e[4])]:null}function Z(t){let[e,i,o,a]=t,s=e/360,l=i/100,n=o/100,c,u,h;if(i===0)c=u=h=n;else{let d=(S,E,p)=>(p<0&&(p+=1),p>1&&(p-=1),p<.16666666666666666?S+(E-S)*6*p:p<.5?E:p<.6666666666666666?S+(E-S)*(.6666666666666666-p)*6:S),m=n<.5?n*(1+l):n+l-n*l,B=2*n-m;c=d(B,m,s+1/3),u=d(B,m,s),h=d(B,m,s-1/3)}return[c,u,h,a]}var R=(t,e,i)=>Math.min(Math.max(t,e),i),b=[.5,.5,.5,1];var y="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",w=()=>window.matchMedia("(prefers-reduced-motion: reduce)").matches,U={u_scale:1,u_rotation:0,u_offsetX:0,u_offsetY:0,u_originX:.5,u_originY:.5,u_worldWidth:0,u_worldHeight:0};function A(t){let e=t.closest(".lm, .lmb, .lmline");e&&e.classList.add("is-failed")}function L(t){if(!(!t||t.__lm))try{t.__lm=new g(t,x,{u_colorBack:f("#bdbdc2"),u_colorTint:f("#ffffff"),u_image:y,u_isImage:!1,u_shape:_.none,u_contour:.4,u_distortion:.14,u_softness:.42,u_repetition:1.5,u_shiftRed:.22,u_shiftBlue:.22,u_angle:104,u_fit:v.cover,...U},void 0,w()?0:.55,18e3)}catch{A(t)}}function T(t){if(!t||t.__lm)return;let e=t.closest(".lmb"),i=t.closest("a, button")||e;try{t.__lm=new g(t,x,{u_colorBack:f("#bdbdc2"),u_colorTint:f("#ffffff"),u_image:y,u_isImage:!1,u_shape:_.circle,u_repetition:4,u_softness:.5,u_shiftRed:.3,u_shiftBlue:.3,u_distortion:0,u_contour:0,u_angle:45,u_fit:v.contain,...U,u_scale:8,u_offsetX:.1,u_offsetY:-.1},void 0,w()?0:.6,Math.random()*2e4)}catch{A(t);return}if(w())return;let o=t.__lm,a=!1,s=()=>o.setSpeed(a?1:.6);i.addEventListener("pointerenter",()=>{a=!0,s()}),i.addEventListener("pointerleave",()=>{a=!1,s()}),i.addEventListener("focus",()=>{a=!0,s()}),i.addEventListener("blur",()=>{a=!1,s()}),i.addEventListener("click",()=>{o.setSpeed(2.4),setTimeout(s,300)})}function O(t){if(!(!t||t.__lm))try{t.__lm=new g(t,x,{u_colorBack:f("#bdbdc2"),u_colorTint:f("#ffffff"),u_image:y,u_isImage:!1,u_shape:_.none,u_contour:.4,u_distortion:.18,u_softness:.35,u_repetition:3,u_shiftRed:.25,u_shiftBlue:.25,u_angle:90,u_fit:v.cover,...U},void 0,w()?0:.6,12e3)}catch{A(t)}}function G(t){if(!(!t||t.__lm))try{t.__lm=new g(t,x,{u_colorBack:f("#bdbdc2"),u_colorTint:f("#ffffff"),u_image:y,u_isImage:!1,u_shape:_.circle,u_repetition:3,u_softness:.45,u_shiftRed:.28,u_shiftBlue:.28,u_distortion:.05,u_contour:.2,u_angle:60,u_fit:v.contain,...U,u_scale:4},void 0,w()?0:.45,7e3)}catch{let i=t.closest(".chromeframe");i&&i.classList.add("is-failed")}}function C(){document.querySelectorAll("[data-lm-hero]").forEach(L),document.querySelectorAll("[data-lm-line]").forEach(O),document.querySelectorAll("[data-lm-frame]").forEach(G),document.querySelectorAll("[data-lm-btn]").forEach(t=>{if(!("IntersectionObserver"in window))return T(t);let e=new IntersectionObserver(i=>{i.some(o=>o.isIntersecting)&&(e.disconnect(),T(t))},{rootMargin:"300px"});e.observe(t)})}window.EvaLiquidMetal={mount:L,mountBtn:T,mountLine:O,mountFrame:G};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",C):C();})();
